...
//    teacher_Interface = new Teacher_Interactive_Interface();
    timer = new QTimer();
    ui->lineEdit_username->setFocus();
    student_Interface = new Student_Interactive_Interface();
...
void MainWindow::initPasswordHint()
{
    ...
    QAction* action = ui->lineEdit_password->addAction(QIcon(":/invisible.png"),QLineEdit::TrailingPosition);
    //ui->label_6->setBuddy(ui->lineEdit_password);
...
void MainWindow::passwordShow()
{
    ...
    button->setIcon(QIcon(":/password-Hint.png"));
...
{
    QToolButton *button = qobject_cast<QToolButton *>(sender());
    button->setIcon(QIcon(":/invisible.png"));
    ui->lineEdit_password->setEchoMode(QLineEdit::Password);
}
