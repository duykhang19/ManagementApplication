...
void connectToSqlServer()
{
    if (!checkInternetConnection())
    {
        ...
        msg.setWindowIcon(QIcon(":/jpg/waning.png"));
...
//    db.setDatabaseName("DRIVER={Microsoft Excel Driver (*.xls, *.xlsx, *.xlsm, *.xlsb)};DBQ=" + QString("C:\\Users\\duykh\\Desktop\\duykhan.xlsx"));
//    if(db.open())
//    {
//        qDebug()<<"Connect to Excel sucessfully !";
//    }
//    else{qDebug()<<"Can not connect to Excel !";}
